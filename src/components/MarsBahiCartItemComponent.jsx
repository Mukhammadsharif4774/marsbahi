...
import {marsBahiAllProducts} from '../helpers/marsBahiProducts';

const MarsBahiCartItemComponent = ({item}) => {
  ...
  const productImage = marsBahiAllProducts.find(
    p => p.name === item.name,
  )?.image;
...
export default MarsBahiCartItemComponent;
